      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="rounded-2xl border border-white/[0.08] bg-zinc-950 px-8 pt-10 pb-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 h-11 rounded-xl bg-white text-zinc-900 font-medium text-sm transition-colors hover:bg-zinc-100 active:scale-[0.98]"
          >
